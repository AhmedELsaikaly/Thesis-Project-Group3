...
class SignUp extends React.Component {
  ...
  // rendering the compo
  render() {
    const { fullName,password,email,mobileNumber,gender,profileImg,address } = this.state;
    const values = { fullName,password,email,mobileNumber,gender,profileImg,address};
    return (
